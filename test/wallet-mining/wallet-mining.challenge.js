...
describe('[Challenge] Wallet mining', function () {
  ...
  it('Execution', async function () {
    ...
    console.log(
      `Need to deploy ${nonceRequired} proxies to get access to 20mil`
    );
    ...
    console.log('Executing signed tx to transfer all tokens to player address');
    ...
    console.log('Deploying 43 proxies through Deployer and collecting tokens');
    for (let i = 0; i < 43; i++) {
